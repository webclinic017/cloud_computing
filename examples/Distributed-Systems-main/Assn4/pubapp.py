...
def broker_test() -> None:
    ...
    p = PublisherProxy("Dissemination", z_ip, z_port, topics, history_length)
...
def direct_test() -> None:
    ...
    p = PublisherProxy("Direct", z_ip, z_port, topics, history_length, pub_port)
