...
class SubscriberProxy:
    ...
    def __init__(self, type: str, broker_ip: str, broker_port: str, topic: str, history_length: int) -> None:
        ...
        if self.type == "Direct":
            self.sub = subscriber.DirectSubscriber(broker_ip, broker_port, topic, history_length)
        
        elif self.type == "Broker":
            self.sub = subscriber.ViaBrokerSubscriber(broker_ip, broker_port, topic, history_length)
